...
export default async function fetchNewData() {
    ...
    browser = await puppeteer.launch({ // MOVE TO A TRY BLOCK
        args: chromium.args,
            ...
            */
            ...
            for (const listingUrl of listingUrls) {
                try {
                    ...
                    console.log(`Error received when scraping in for loop for each listing: ${error}`)
                }


            }
        }
        await addCars(allListings)
    } catch (error) {
